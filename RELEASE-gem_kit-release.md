...
gem kit changelog --gem gem_kit-release 0.2.0       # format, plus "is this version ready?"
```
...
Creates `gem_kit-release-v0.2.0`, refusing if it already exists. The tag is also what
